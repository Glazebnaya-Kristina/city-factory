...
grunt.initConfig({
	...
	uglify: {
		dist: {
			files: {
				...
				'../markup/js/buyers.min.js': ['dist/js/buyers.js'],
    ...
    htmlbuild: {
        dist: {
            ...
            comments: '<%= fixturesPath %>/templates/comments.html',
						searchMobPopup: '<%= fixturesPath %>/templates/searchMobPopup.html',
						mobCatalogPopup: '<%= fixturesPath %>/templates/mobCatalogPopup.html',
						basketPopup: '<%= fixturesPath %>/templates/basketPopup.html',
						registrationPopup: '<%= fixturesPath %>/templates/registration.html',
